...
import voc_classes
from reader_voc import AsyncReader, ReaderOpts
...
voc_path = '/media/xian/data/datasets/VOCdevkit'
batch_size = 8
nworkers = 6
train_reader_opts = ReaderOpts(voc_path, 'train', batch_size, img_height, img_width, gt_height, gt_width, nworkers)
val_reader_opts = ReaderOpts(voc_path, 'val', batch_size, img_height, img_width, gt_height, gt_width, nworkers)

nepochs = 200

net = create_model(len(voc_classes.class_names))
